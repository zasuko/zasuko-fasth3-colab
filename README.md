...
**① 外見を文章でも必ず書く**／**② 1カットに1.5〜2秒を確保する**。この2つが揃えば **R2V（参照画像から動画）で十分に似ます**。

実測でははっきり差が出ました。

| 条件 | 結果 |
| --- | --- |
| 外見の文章**なし**＋参照画像だけ | ❌ **まったくの別人**になった |
| 外見の文章あり＋**1カット0.65秒**（5.17秒に8カット） | △ 似ているが別人。余計な装飾が生える |
| 外見の文章あり＋**1カット1.9秒**（15秒に8カット） | ✅ **同一性を保てた** |

**効いているのは尺です。** 1カットを描き切る前に次のカットへ行かされると崩れます。
